...
Furthermore, Amanzi-ATS relies on a meshing infrastructure, MSTK, \cite{}  which can generate meshes as subdomains or subsets of existing meshes.
...
This mesh is altered to ensure it is a one-dimensional submanifold of three-dimensional space, i.e. each cell has two faces, and all face-normals are $\tinyfrac{+}{-} \hat{z}$.
...
Few mesh capabilities support this fully-unstructured mesh type; a Silo\cite{} capability was added to to Amanzi-ATS's existing output options to enable visualization of the resulting solution.
